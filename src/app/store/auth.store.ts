...
interface AuthState {
  ...
  setTokens: (accessToken: string, refreshToken: string, user: Omit<User, 'onboarding_completado'> & { onboarding_completado?: boolean }) => void;
...
export const useAuthStore = create<AuthState>((set) => ({
 ...
 setTokens: (accessToken, refreshToken, user) => {
  ...
  localStorage.setItem('edifai_user', JSON.stringify(normalizedUser));
  set({ accessToken, refreshToken, user: normalizedUser, isAuthenticated: true });
},
