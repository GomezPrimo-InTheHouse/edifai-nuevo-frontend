        ...
        <>
          <Card elevation={0} sx={{ borderRadius: 3, mb: 2, p: 2, border: `1px solid ${theme.palette.divider}`, bgcolor: 'background.paper' }}>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} flexWrap="wrap" useFlexGap alignItems="center">
              <TextField select size="small" label={t('compras.form.obra')} sx={{ minWidth: 160 }}
                value={filtroObra}
              ...
              <TextField select size="small" label={t('compras.form.especialidad')} sx={{ minWidth: 160 }}
              ...
              <TextField select size="small" label={t('compras.filtros.modo_fecha')} sx={{ minWidth: 140 }}
                value={modoFecha}
              ...
              {modoFecha === 'rango' ? (
                <>
                  <TextField size="small" type="date" label={t('compras.filtros.desde')} sx={{ minWidth: 150 }}
                    value={fechaDesde} onChange={(e) => setFechaDesde(e.target.value)} InputLabelProps={{ shrink: true }} />
                  <TextField size="small" type="date" label={t('compras.filtros.hasta')} sx={{ minWidth: 150 }}
                    value={fechaHasta} onChange={(e) => setFechaHasta(e.target.value)} InputLabelProps={{ shrink: true }} />
                </>
              ) : (
                <TextField size="small" type="month" label={t('compras.filtros.mes')} sx={{ minWidth: 150 }}
