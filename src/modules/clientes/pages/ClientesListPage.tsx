...
//   if (isError) return <ErrorState title="Error" message="No se pudo cargar la lista de clientes." onRetry={refetch} />;
...
//           <Typography variant="h6" color="text.secondary">No hay clientes registrados</Typography>
...
//                         <Typography variant="caption" sx={{ color: '#64748B' }}>{cliente.razon_social}</Typography>
//                       )}
//                     </Box>
...
//                         <Typography variant="body2" sx={{ color: '#475569' }}>{cliente.telefono}</Typography>
//                       </Stack>
//                     )}
//                     {cliente.email && (
//                       <Stack direction="row" alignItems="center" gap={1}>
//                         <Mail size={14} color="#94A3B8" />
//                         <Typography variant="body2" sx={{ color: '#475569' }}>{cliente.email}</Typography>
//                       </Stack>
//                     )}
//                     {cliente.direccion && (
//                       <Stack direction="row" alignItems="center" gap={1}>
//                         <MapPin size={14} color="#94A3B8" />
//                         <Typography variant="body2" sx={{ color: '#475569' }}>{cliente.direccion}</Typography>
//                       </Stack>
//                     )}
//                     {cliente.dni_cuit && (
//                       <Chip label={`DNI/CUIT: ${cliente.dni_cuit}`} size="small" sx={{ width: 'fit-content', bgcolor: '#F1F5F9' }} />
//                     )}
//                   </Stack>
//                 </CardContent>
//               </Card>
