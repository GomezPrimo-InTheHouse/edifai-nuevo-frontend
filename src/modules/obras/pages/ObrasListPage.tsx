...
export function ObrasListPage() {
  ...
  // ← estados primero, antes de usarlos en el hook
  ...
  const { data: response, isLoading, isError, refetch } = useObrasList(page, limit);
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
              ...
              <Typography variant="caption" sx={{
                ...
                px: 1, py: 0.5, borderRadius: 1, color: 'text.secondary',
              }}>
                ID: {obra.id}
              </Typography>
            </Box>
  ...
  return (
    <AppLayout>
      ...
      <Paper sx={{
        ...
        <TextField fullWidth size={isMobile ? 'small' : 'medium'}
      ...
      {/* Paginación — solo en tab activas */}
      {tab === 0 && pagination && pagination.totalPages > 1 && (
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 2, mt: 3, pb: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Página {pagination.page} de {pagination.totalPages} — {pagination.total} obras
          </Typography>
          <Button variant="outlined" size="small"
