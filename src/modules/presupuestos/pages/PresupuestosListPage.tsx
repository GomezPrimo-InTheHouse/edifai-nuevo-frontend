...
import {
  ...
  Pagination, Paper, Stack, Tab, Table, TableBody, TableCell, TableHead, TableRow,
...
export const PresupuestosListPage = () => {
  ...
  useEffect(() => {
    setPage(1);
  }, [search, filtroObra, filtroEspecialidad, filtroTrabajador, tab]);
  ...
  return (
    <AppLayout>
      ...
      {!isLoadingCurrent && totalPaginas > 1 && (
