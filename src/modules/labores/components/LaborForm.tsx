  ...
  return (
    <Stack direction="row" alignItems="center" gap={1} mb={2}>
      <Box sx={{
        ...
        <Typography sx={{ color: completado ? '#fff' : theme.palette.text.secondary, fontSize: 12, fontWeight: 800 }}>
          {completado ? '✓' : numero}
        </Typography>
      </Box>
      <Box>
        ...
        <Stack spacing={3}>
          ...
          <SeccionAnimada visible={mostrarFechas}>
            ...
            <Stack direction="row" alignItems="center" gap={1} mb={1}>
              ...
              <Box>
                <Typography variant="body1" fontWeight={700}>Fechas del trabajo</Typography>
                <Typography variant="caption" color="text.secondary">
                ...
                <>
                  <Grid size={{ xs: 12 }}>
                    <Stack direction="row" alignItems="center" gap={0.75} sx={{ mt: 1, mb: -0.5 }}>
                      <CalendarCheck size={13} color={theme.palette.text.disabled} />
                      <Typography variant="caption" color="text.disabled" fontWeight={600}>
                        Fechas reales — se completan al iniciar y finalizar el trabajo
                      </Typography>
                    </Stack>
                  </Grid>
                  <Grid size={{ xs: 12, md: 6 }}>
